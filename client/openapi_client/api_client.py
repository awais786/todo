...
from client.openapi_client.api_response import ApiResponse, T as ApiResponseT
import client.openapi_client.models
from client.openapi_client import rest
from client.openapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(client.openapi_client.models, klass)
