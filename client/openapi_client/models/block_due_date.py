...
class BlockDueDate(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr
    due_datetime: StrictStr
    student: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Email or username of user to change access")
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["url", "due_datetime", "student", "reason"]
