...
class ListInstructorTaskInput(BaseModel):
    """
    ...
    """ # noqa: E501
    unique_student_identifier: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Email or username of student")
    problem_location_str: Optional[StrictStr] = Field(default=None, description="Problem location")
    __properties: ClassVar[List[str]] = ["unique_student_identifier", "problem_location_str"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "problem_location_str": obj.get("problem_location_str")
        })
        return _obj
